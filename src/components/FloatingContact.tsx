            ...
            <div className="p-10 flex flex-col md:flex-row gap-10">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 bg-gray-900 text-yellow-400 rounded-2xl flex items-center justify-center font-bold text-xl border border-gray-700">
                    CASIO
                  </div>
                  <div>
                ...
                <div className="space-y-4 text-sm text-gray-600">
                  <p className="flex items-start gap-3">
                    📍 <span>12 Nguyễn Văn Bảo, Hạnh Thông, Hồ Chí Minh 700000, Việt Nam</span>
                  </p>
                  <p className="flex items-start gap-3">
                    📞 <span>024.2217.9999</span>
                  </p>
                  <p className="flex items-start gap-3">
                    🟢 <span className="text-green-600 font-medium">Đang mở cửa</span> • Mở cửa lúc
                    09:00
                  </p>
                </div>
              </div>
              ...
              <div className="w-full md:w-56 flex flex-col items-center justify-center border-l border-gray-100 md:pl-10">
                <div className="bg-white p-3 border-2 border-dashed border-gray-200 rounded-3xl mb-4">
                  ...
                  <img
                    src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://zalo.me/your-id"
                    alt="Zalo QR"
                    className="w-40 h-40"
                  />
                </div>
